...
| `briefing.mjs` | "Brief me": the ranked daily brief, cached and offered each morning. Each time it is served, lines get their links and anything finished since (task ticked off, email replied) is marked done |
